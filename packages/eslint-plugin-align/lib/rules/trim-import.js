 ...
 *
 * Vendored from eslint-plugin-align-import@1.0.0 (MIT, Copyright (c) 2020
 * Simon Reinisch). Upstream is unmaintained since 2022 and crashes on ESLint 9+.
 * Local changes: sourceCode accessor shim.
 */
'use strict';
